        ...
        <nav class="site-nav">
            <div class="nav-content">
                ...
                <label for="nav-toggle" class="nav-burger" aria-label="Toggle navigation"
                    aria-controls="primary-nav"></label>
    ...
    <footer class="fv-footer">
        <div class="fv-footer-container">
            <div class="fv-footer-brand">
                ...
                <button class="fv-footer-btn" onclick="window.location='{{ url('/legal/terms') }}'">Terms of Use &
                    Privacy Statement</button>
                <form class="nav-search" action="/search" method="get" role="search">
                    <input type="search" class="nav-search__input" name="q" value="{{ request('q') }}"
                        placeholder="Search projects, services…" aria-label="Search FortiVine" required>
        ...
        <div class="fv-footer-bottom">© {{ date('Y') }} FortiVine Tech — Where Technology and Sustainability Intertwined
        </div>
    </footer>
</body>
